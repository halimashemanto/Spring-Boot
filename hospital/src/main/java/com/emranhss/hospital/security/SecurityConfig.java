    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        return http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers("/api/user/", "/images/**", "/auth/all","/api/doctor/**","/api/doctor/","/api/user/active/**", "/auth/login","/api/nurse/**","/api/receptionist/**","/api/officeStaff/**","/api/tests/**","/api/medicine/**","/api/department/**","/api/slot/**", "/api/slot/")
                                .permitAll()
